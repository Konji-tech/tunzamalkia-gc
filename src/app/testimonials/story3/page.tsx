    ...
    <div className="p-8 bg-white w-screen h-screen">
      ...
      <div className="font-poppins p-16 text-justify">
        <p>
          ...
          things didnt make me weak—it made me strong.Now, I share my story in the hope that it might help another woman, just like my friend’s story helped me.
          We dont have to face these challenges alone. Together, we can break the silence and support each other on our journeys to understanding, healing, and
          empowerment.
        </p>
      </div>
      <h2 className="text-2xl font-bold mt-6">Join The Conversation</h2>
      <p className="mb-4 text-justify">
        Your voice can inspire change. Share your story anonymously and help other women feel seen, heard, and supported.When comfortable and ready,click below
        to share your story{" "}
      </p>
